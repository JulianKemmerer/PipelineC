...
// TODO confirm 1x1, especially pipelined works
// TODO convert dual frame buffer to match more likely 1 address space of RAM from Litex etc
//  better use of dual port RAM mixing writes and reads ~equally?

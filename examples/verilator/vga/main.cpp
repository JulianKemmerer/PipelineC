...
Compile like:
# From pipelinec repo:
$ ./src/pipelinec ./examples/arty/src/vga/test_pattern.c --sim_comb --verilator --out_dir ~/pipelinec_output
...
#include "../../arty/src/vga/test_pattern.c"
...
//#define USE_VERILATOR_MAKE

//#ifndef USE_VERILATOR_MAKE
...
#define clk clk_25p0 //clk_148p5 for 1920x1080

...
#define MULTI_HOST_CLK_SHARED_RESOURCE_BUS_TOTAL_HOST_PORTS 4
#define MULTI_HOST_CLK_SHARED_RESOURCE_BUS_HOST0_NAME     cpu
#define MULTI_HOST_CLK_SHARED_RESOURCE_BUS_HOST0_PORTS    3
#define MULTI_HOST_CLK_SHARED_RESOURCE_BUS_HOST0_CLK_MHZ  CPU_CLK_MHZ

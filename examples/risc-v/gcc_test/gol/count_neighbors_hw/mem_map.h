...
#define COUNT_NEIGHBORS_HW_OUT_ADDR (COUNT_NEIGHBORS_HW_IN_ADDR + sizeof(count_neighbors_in_valid_t))
#define COUNT_NEIGHBORS_MEM_MAP_NEXT_ADDR (COUNT_NEIGHBORS_HW_OUT_ADDR + sizeof(count_neighbors_out_valid_t))

...
GLOBAL_PIPELINE_INST_W_ARB(PPCAT(SHARED_RESOURCE_BUS_PIPELINE_NAME,_pipeline), SHARED_RESOURCE_BUS_PIPELINE_OUT_TYPE, SHARED_RESOURCE_BUS_PIPELINE_FUNC, SHARED_RESOURCE_BUS_PIPELINE_IN_TYPE, NUM_THREADS)
...
MAIN_MHZ(PPCAT(SHARED_RESOURCE_BUS_PIPELINE_NAME,_dev_arb_connect), DEV_CLK_MHZ)
void PPCAT(SHARED_RESOURCE_BUS_PIPELINE_NAME,_dev_arb_connect)()
{
  // Arbitrate M hosts to 1 dev
  SHARED_BUS_MULTI_HOST_CONNECT(SHARED_RESOURCE_BUS_PIPELINE_TYPE_NAME, SHARED_RESOURCE_BUS_PIPELINE_NAME, SHARED_RESOURCE_BUS_PIPELINE_HOST_THREADS, 1)

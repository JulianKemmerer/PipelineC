...
// TODO USE name TO RENAME everything
...
PRAGMA_MESSAGE(INST_ARRAY host_to_dev_wire_on_host_clk host_to_dev_wires_on_host_clk) \
dev_to_host_t dev_to_host_wires_on_host_clk[NUM_HOST_PORTS]; \
PRAGMA_MESSAGE(INST_ARRAY dev_to_host_wire_on_host_clk dev_to_host_wires_on_host_clk) \

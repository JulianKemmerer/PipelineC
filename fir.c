...
#define FIR_N_TAPS 2048
#define LOG2_FIR_N_TAPS 11 //  log2(FIR_N_TAPS)
#define output_t uint43_t // data_width + coeff_width + log2(taps#)
...
data_t fir_main(data_t input, coeff_t coeffs[FIR_N_TAPS])
{

...
| `AUTO_COMB_SHARE` / `AUTO_COMB_UNSHARE`: combinational area / delay optimization (New, experimental) | [Yes](docs/pypeline_guide.md#auto_comb_share--auto_comb_unshare-new-experimental) | No |

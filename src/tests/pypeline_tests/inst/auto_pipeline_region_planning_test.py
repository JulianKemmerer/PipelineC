#!/usr/bin/env python3
"""Unit coverage for the constrained-AUTO_PIPELINE region planner in SWEEP.py
(AUTO_PIPELINE(func, latency= / start_latency= / max_latency=)):
...
end to end by auto_pipeline_constraints_test.py and the fixed-latency
...
if __name__ == "__main__":
    ...
    print("All AUTO_PIPELINE region planning unit tests passed.")

...
AUTO_FSM.py's area model (AUTO_FSM.UM2_PER_ABSTRACT_AREA_UNIT) was measured
...
def test_um2_per_abstract_area_unit_matches_committed_cache():
    ...
    assert rel_err < 0.05, (
        ...
        f"committed cache entries, but AUTO_FSM.UM2_PER_ABSTRACT_AREA_UNIT = "
        f"{AUTO_FSM.UM2_PER_ABSTRACT_AREA_UNIT} -- {rel_err:.1%} off; refit "

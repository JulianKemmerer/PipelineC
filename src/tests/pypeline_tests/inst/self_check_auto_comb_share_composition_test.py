"""ACS composed with fixed/discovered pipelines, MCP and default AUTO_FSM."""
import os
import sys

sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), "../../..")))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), "../../../../include/pypeline")))
from pypeline import (AUTO_COMB_SHARE, AUTO_PIPELINE, MAIN, PART, NamedTuple, Reg, hw_func,
...
MCP, MCP_T = make_stream_auto_multi_cycle(ACS, latency=3)

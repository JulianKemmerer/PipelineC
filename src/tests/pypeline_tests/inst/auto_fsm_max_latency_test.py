#!/usr/bin/env python3
"""AUTO_FSM `max_latency=` end-to-end test.
...
DESIGN = os.path.join(THIS_DIR, "auto_fsm_max_latency_design.py")
...
def main():
    ...
    base = args.out_dir or os.path.join(THIS_DIR, "auto_fsm_max_latency_test_out")
    ...
    print("AUTO_FSM max_latency test passed.")

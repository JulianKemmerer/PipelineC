...
"""Design for the AUTO_FSM resource-comparison test
(auto_fsm_resources_compare_test.py).

Deliberately expensive and deliberately repetitive: six multiplies and five
same-width adds, all of which AUTO_FSM can fold onto ONE multiplier and ONE
...
@MAIN(12.0)
def auto_fsm_resources_top(start: uint1_t, x: mul_in_t) -> int32_t:

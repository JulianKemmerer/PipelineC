...
python3 ./src/tests/pypeline_tests/inst/stream_pipeline_test.py
rm -rf ~/pypeline_run_all/*; ./src/pipelinec ./src/tests/pypeline_tests/inst/stream_pipeline_test.py --out_dir ~/pypeline_run_all
...
python3 ./src/tests/pypeline_tests/inst/stream_fifo_test.py
rm -rf ~/pypeline_run_all/*; ./src/pipelinec ./src/tests/pypeline_tests/inst/stream_fifo_test.py --out_dir ~/pypeline_run_all --comb
...
python3 ./src/tests/pypeline_tests/inst/dwidth_converter_test.py
rm -rf ~/pypeline_run_all/*; ./src/pipelinec ./src/tests/pypeline_tests/inst/dwidth_converter_test.py --out_dir ~/pypeline_run_all --comb

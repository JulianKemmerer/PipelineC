...
rm -rf ~/pypelinec_output/*; ./src/pipelinec ./src/tests/pypeline_tests/inst/float32_add_test.py --out_dir ~/pypelinec_output --comb
...
rm -rf ~/pypelinec_output/*; ./src/pipelinec ./src/tests/pypeline_tests/inst/compound_init_test.py --out_dir ~/pypelinec_output --comb --no_synth

rm -rf ~/pypelinec_output/*; ./src/pipelinec ./src/tests/pypeline_tests/inst/bit_manip_test.py --out_dir ~/pypelinec_output --comb --no_synth

rm -rf ~/pypelinec_output/*; ./src/pipelinec ./src/tests/pypeline_tests/inst/import_test.py --out_dir ~/pypelinec_output --comb --no_synth

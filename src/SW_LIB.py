...
GENERATED_HEADER_DIRS = [CLOCK_CROSS_HEADER,TYPE_ARRAY_N_T_HEADER]
...
def GEN_EMPTY_GENERATED_HEADERS(text):
	...
	GEN_EMPTY_TYPE_ARRAY_N_HEADERS(text)
	GEN_EMPTY_CLOCK_CROSS_HEADERS(text)

def GEN_EMPTY_CLOCK_CROSS_HEADERS(text):
...
typedef struct ''' + array_type + '''
{
	''' + elem_t + ''' data[''' + size_str + '''];
		...
		# Write file
		path = SYN.SYN_OUTPUT_DIRECTORY + "/" + TYPE_ARRAY_N_T_HEADER + "/" + elem_t + "_array_N_t.h"
		open(path,'w').write(text)
